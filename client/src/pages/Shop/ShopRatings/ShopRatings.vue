      ...
      <div class="ratingselect">
        <div class="rating-type border-1px">
          ...
          <span class="block negative" :class="{active: selectType===1}" @click="setSelectType(1)">
            不满意<span class="count">{{ratings.length-satisfied}}</span>
          </span>
        </div>
        <div class="switch" :class="{on: textMust}" @click="toggleTextMust">
          <span class="iconfont icon-check_fill"></span>
        ...
        <ul>
          <li class="rating-item" v-for="(rating, index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="recommend">
                <span class="iconfont" :class="rating.rateType===0 ? 'icon-like-full' : 'icon-badreview-full'"></span>
...
<script>
  ...
  export default {
    data () {
      return {
        selectType: 2, //选择分类：0 满意 1 不满意 2 全部
        textMust: false,
        _this: this
      }
    },
    computed: {
      ...
      filterRatings () {
        const {ratings, selectType, textMust} = this
        /*
          条件一
            selectType 2 全要
        ...
        */
        return ratings.filter(rating => {
          return (selectType === 2 || selectType === rating.rateType) && (!textMust || rating.text.length > 0)
        })
      }
    },
    methods: {
      ...
      .rating-item
        ...
        .content
          ...
          .recommend
            line-height: 16px
            font-size: 0
            .icon-like-full, .icon-badreview-full, .item
              display: inline-block
              margin: 0 8px 4px 0
              font-size: 9px
            .icon-like-full
